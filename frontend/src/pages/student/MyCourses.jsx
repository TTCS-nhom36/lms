      ...
      {courses.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {courses.map((c, i) => (
            ...
            >
              <div className="h-28 bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center relative">
                {c.thumbnailUrl ? (
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <ArrowRight size={14} className="text-gray-300 group-hover:text-red-500 group-hover:translate-x-0.5 transition-all" />
                </div>
              </div>
            </div>
          ))}
